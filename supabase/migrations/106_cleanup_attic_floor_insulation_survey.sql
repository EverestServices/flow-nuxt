-- ============================================================================
-- Migration: Cleanup Attic Floor Insulation Survey Pages and Questions
-- Description: Removes all SurveyPages and SurveyQuestions for the
--              Padlásfödém szigetelés (Attic Floor Insulation) investment
...
BEGIN
    -- ========================================================================
    -- STEP 1: Find the Attic Floor Insulation investment
    -- ========================================================================

    SELECT id INTO inv_attic_floor_id
    FROM public.investments
    WHERE persist_name = 'roofInsulation';  -- This is the persist_name for Padlásfödém szigetelés

    IF inv_attic_floor_id IS NULL THEN
        RAISE NOTICE 'Attic Floor Insulation investment not found (persist_name: roofInsulation)';
        RETURN;
    END IF;
    ...
    WHERE sp.investment_id = inv_attic_floor_id;
    ...
    WHERE sa.survey_question_id = sq.id
      ...
      AND sp.investment_id = inv_attic_floor_id;
    ...
    RAISE NOTICE '========================================';
    RAISE NOTICE 'Successfully cleaned up Attic Floor Insulation (Padlásfödém szigetelés)';
